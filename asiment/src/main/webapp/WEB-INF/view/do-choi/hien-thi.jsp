...
<body>
<h5><p class="text-center">Đồ chơi</p></h5>
    ...
    <div class="row">
        ...
        <div class="col-10">
            ...
            <div class="form-container">
                <form:form method="POST" action="/do-choi/add" modelAttribute="doChoi">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${ListSP}" var="sp" varStatus="i">
                                        <tr>
                                            ...
                                            <td>${sp.ten}</td>
                                            <td>
                                                <a href="/do-choi/view-update/${sp.id}"
                                                   class="btn btn-sm btn-warning">Edit</a>

                                                <a class="btn btn-sm btn-warning"
                                                   onclick="return confirm('Bạn chắc chắn xóa chứ ?')"
                                                   href="/do-choi/delete/${sp.id}">Delete</a>
