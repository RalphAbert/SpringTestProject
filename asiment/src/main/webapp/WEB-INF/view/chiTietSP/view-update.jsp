...
<div class="container">
    <center>
        <img src="../../../img/${image}" width="300" height="200">
    </center>
    <form:form class="w3-container" action="/chi-tiet-san-pham/edit/${chiTietSPDTO.id}" method="post"
               modelAttribute="chiTietSPDTO" enctype="multipart/form-data" onsubmit="return confirmUpdate()">
    <div class="row">
        <div class="col-6">
    ...
    <script>
        function confirmUpdate() {
            return confirm("Bạn có chắc chắn muốn Update.");
        }</script>
