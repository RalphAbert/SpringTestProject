    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/ban-hang">Trang chủ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/chi-tiet-san-pham">Sản phẩm</a>
                </li>
                <li class="nav-item">
            ...
            <form action="search" method="post" class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-3" href="/gio-hang/${user.id}">
...
<div class="container-fluid">
    <div class="row">
        <c:forEach items="${listChiTietSanPham.getContent()}" var="ctsp">
            <div class="col-3">
                <div class="card mb-3">
                    <a href="/ban-hang/detail/${ctsp.id}">
                        <img src="getimage/${ctsp.image}" class="card-img-top" alt="Product Image">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title">${ctsp.idSP.ten}</h5>
                        <p class="card-text">Price: ${ctsp.giaBan}</p>
